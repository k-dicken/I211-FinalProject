...
//?>
    ...
    <div id='flight-details'>
        <div class='flight-details-section'>
            <p name="" class='flight-title' style='font-size: xx-large'>FLIGHT DETAILS</p>
            <p name="" style='font-size: large'>$date</p>
            <br>
            <p name="" class='flight-airline' style='font-size: x-large; font-weight: bold'>
            <p name="" class='flight-airline' style='font-size: large'>
            <br>
            <br>
            <br>
            <div class='flight-section flight-destination'>
                <input name="fromLocation" class='flight-location flight-margin' style='font-size: xx-large; font-weight: bold'>
                <p class='flight-margin' style='font-size: xx-large'>➝</p>
                <input name="toLocation" class='flight-location' style='font-size: xx-large; font-weight: bold'>
            </div>
